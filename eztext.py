...
class Input:
    ...
    def __init__(self, **options):
        ...
        self.options = Config(options, ['x', '0'], ['y', '0'], ['font','pygame.font.Font("relay-medium.ttf", 25)'],
 ...
 '\'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!"#$%&\\\'()*+,-./:;<=>?@[\]^_`{|}~\''],
    ...
    def draw(self, surface):
        ...
        size = self.font.size(self.prompt+('_'*self.maxlength))
        sur = pygame.Surface((size[0],size[1]))
        sur.fill((255,255,255))
        surface.blit(sur,(self.x,self.y))
